function BP_locations(geojson_features){
    ...
    for (var i=0; i<Object.keys(geojson_features).length;i++){
        ...
        var popcontent="Issued Date: "+geojson_features[i].properties.issueddate+"<br>"+
                        "Work Class Group: "+geojson_features[i].workclassgroup+"<br>"+
                        "Contractor Name: "+geojson_features[i].contractorname+"<br>"+
                        "Community Name: "+geojson_features[i].communityname+"<br>"+
                        "Original Address: "+geojson_features[i].originaladdress;
